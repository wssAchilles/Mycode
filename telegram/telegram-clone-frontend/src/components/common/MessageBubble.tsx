        ...
        <div className={`tg-message-bubble ${isOut ? 'is-out' : 'is-in'} ${withTail ? 'has-tail' : ''} ${isMedia ? 'is-media' : ''} ${className}`}>
            ...
            {withTail && (
                <svg className="tg-message-tail" width="9" height="20" viewBox="0 0 9 20" xmlns="http://www.w3.org/2000/svg">
                    {isOut ? (
                        <path d="M0,0 C1.04936081,0 4.14188059,0.306001275 6.00767232,0.92787075 C9.88371286,2.21997233 8.35824963,7.91039804 7.64917409,10.5562719 C7.2797672,11.934887 6.27532354,16.5921867 5.0747472,18.0673322 C4.58287711,18.671694 2.8290325,19.3496032 0,20 L0,0 Z" fill="var(--bubble-out-bg, #eeffde)" fillRule="evenodd" />
                    ) : (
                        <path d="M9,0 C7.95063919,0 4.85811941,0.306001275 2.99232768,0.92787075 C-0.883712864,2.21997233 0.641750371,7.91039804 1.35082591,10.5562719 C1.7202328,11.934887 2.72467646,16.5921867 3.9252528,18.0673322 C4.41712289,18.671694 6.1709675,19.3496032 9,20 L9,0 Z" fill="var(--bubble-in-bg, #ffffff)" fillRule="evenodd" />
                    )}
                </svg>
            )}
        </div>
