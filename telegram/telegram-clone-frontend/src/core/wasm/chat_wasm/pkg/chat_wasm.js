/* @ts-self-types="./chat_wasm.d.ts" */

/**
 * @returns {string}
 */
export function chat_wasm_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.chat_wasm_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {any}
 */
export function compact_message_patches(patches) {
    const ret = wasm.compact_message_patches(patches);
    if (ret[2]) {
...
/**
 * @param {Uint32Array} existing
 * @param {Uint32Array} incoming
 * @returns {Uint32Array}
 */
export function diff_sorted_unique_u32(existing, incoming) {
    const ptr0 = passArray32ToWasm0(existing, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(incoming, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.diff_sorted_unique_u32(ptr0, len0, ptr1, len1);
 ...
 * @returns {Array<any>}
 */
export function merge_and_diff_sorted_unique_u32(existing, incoming) {
    const ptr0 = passArray32ToWasm0(existing, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(incoming, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.merge_and_diff_sorted_unique_u32(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Uint32Array}
 */
export function merge_sorted_unique_u32(existing, incoming) {
    const ptr0 = passArray32ToWasm0(existing, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(incoming, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.merge_sorted_unique_u32(ptr0, len0, ptr1, len1);
    var v3 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v3;
}
 ...
 * @returns {Uint32Array}
 */
export function search_contains_indices(messages, query, limit) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.search_contains_indices(ptr0, len0, ptr1, len1, limit);
    var v3 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v3;
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_from_slice_77822cdd1c40fd7f: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chat_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
