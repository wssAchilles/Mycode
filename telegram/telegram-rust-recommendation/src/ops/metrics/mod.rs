...
pub struct RecommendationMetrics {
    ...
    last_graph_materializer_requested_author_count: Option<usize>,
    last_graph_materializer_unique_author_count: Option<usize>,
    last_graph_materializer_returned_post_count: Option<usize>,
