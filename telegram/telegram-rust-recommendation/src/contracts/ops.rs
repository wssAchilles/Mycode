...
pub struct RecommendationOpsRuntime {
    ...
    pub contract_version_catalog_version: String,
    pub pipeline_boundary_version: String,
    pub workspace_migration_prep_version: String,
    pub workspace_migration_state: String,
    pub algorithm_contract_version: String,
    ...
    pub ranking_score_role_version: String,
    pub selector_policy_version: String,
    pub selector_audit_version: String,
    pub selector_constraint_version: String,
    pub selector_score_source_version: String,
...
pub struct RecommendationOpsSummary {
    ...
    pub last_graph_materializer_requested_author_count: Option<usize>,
    pub last_graph_materializer_unique_author_count: Option<usize>,
    pub last_graph_materializer_returned_post_count: Option<usize>,
