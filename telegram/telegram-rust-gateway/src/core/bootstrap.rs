use crate::{
    ...
    realtime_contracts::{
        REALTIME_COMPAT_DISPATCH_SPEC_VERSION, REALTIME_DELIVERY_SPEC_VERSION,
...
pub fn seed_control_plane(plane: &mut RuntimeControlPlane, config: &GatewayConfig) {
    ...
    plane.mark_unit(MarkUnitInput {
        ...
        retries: Some(0),
        runtime_owner: Some(config.realtime_socket_terminator_owner()),
        contract_version: Some(REALTIME_COMPAT_DISPATCH_SPEC_VERSION),
    ...
    plane.mark_unit(MarkUnitInput {
        ...
        retries: Some(0),
        runtime_owner: Some(config.realtime_fanout_owner()),
        contract_version: Some(REALTIME_EVENT_SPEC_VERSION),
