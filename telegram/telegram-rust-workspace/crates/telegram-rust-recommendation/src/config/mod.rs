...
pub struct RecommendationConfig {
    ...
    pub recent_hot_shard_count: usize,
    ...
    pub cache_singleflight_enabled: bool,
    pub cache_local_capacity: u64,
...
impl RecommendationConfig {
    pub fn from_env() -> Result<Self> {
        Ok(Self {
            ...
            recent_hot_shard_count: parse_env("RUST_RECOMMENDATION_RECENT_HOT_SHARD_COUNT", 16)?,
