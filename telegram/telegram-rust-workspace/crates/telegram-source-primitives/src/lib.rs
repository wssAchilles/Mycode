...
mod tests {
    use super::{
        ...
        SOURCE_DETAIL_PRE_POLICY_COUNT_FIELD, SOURCE_DETAIL_RETRIEVAL_LANE_FIELD,
        SOURCE_DETAIL_SOURCE_BUDGET_FIELD, SOURCE_SIGNAL_NORMALIZED_SCORE_FIELD,
        SOURCE_SIGNAL_POLICY_SURVIVAL_RATE_FIELD, SOURCE_STAGE_CANDIDATE_COUNT_FIELD,
        SOURCE_STAGE_CONTRACT_VERSION, SOURCE_STAGE_CONTRACT_VERSION_FIELD,
        SOURCE_STAGE_ENABLED_FIELD, SOURCE_STAGE_ERROR_CLASS_FIELD, SOURCE_STAGE_ERROR_FIELD,
