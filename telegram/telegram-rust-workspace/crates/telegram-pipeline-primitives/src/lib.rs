...
mod tests {
    use super::{
        CANONICAL_PIPELINE_STAGE_ORDER, PIPELINE_BOUNDARY_VERSION,
        PIPELINE_MANIFEST_CRITICALITY_CRITICAL, PIPELINE_MANIFEST_EXECUTION_GRAPH_FANOUT_CPP,
        PIPELINE_MANIFEST_FALLBACK_KEEP_BACKUP, PIPELINE_MANIFEST_TRANSPORT_IN_PROCESS,
        PIPELINE_OWNER_CPP, PIPELINE_OWNER_NODE_PROVIDER, PIPELINE_OWNER_RUST,
        PIPELINE_SPACE_FEED_EXPERIMENT_ID, PIPELINE_STAGE_GRAPH_PROVIDER, PIPELINE_STAGE_SCORERS,
        PIPELINE_TRACE_MODE_CACHE_REPLAY, PIPELINE_TRACE_MODE_LIVE, PIPELINE_TRACE_VERSION,
    ...
    fn exports_stable_pipeline_stage_and_owner_contracts() {
        ...
        assert_eq!(CANONICAL_PIPELINE_STAGE_ORDER.len(), 9);
    }
}
