...
export const RETRIEVAL_SIGNAL_KEYS = [
    ...
    'retrievalGraphPathConfidence',
    'retrievalGraphPathFreshness',
...
export const RANKING_SIGNAL_KEYS = [
    ...
    'recencyMultiplier',
    'ageHours',
    'coldStartInterestStrength',
    'coldStartInterestPolicyMatch',
    'coldStartInterestTrendMatch',
    'coldStartInterestMultiplier',
    'trendAffinityMatch',
    'trendAffinityStrength',
    'trendAffinityMultiplier',
    'trendPersonalizationMatch',
    'trendPersonalizationInterest',
    ...
    'fatigueCrossPagePressure',
    'fatigueMultiplier',
    'sessionSuppressionStrength',
    'sessionSemanticOverlap',
    'sessionSemanticSuppression',
    'sessionTrendTopicPressure',
    ...
    'strategyVersionHash',
    'componentBaseScore',
    'componentActionScore',
    'componentQualityScore',
    'componentFreshnessScore',
    'componentDiversityPenalty',
    'componentNegativePenalty',
