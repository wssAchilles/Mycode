...
const recommendationRetrievalSummaryPayloadSchema = z.object({
  ...
  sourceOutcomeCounts: z.record(z.string(), z.number().int().min(0)).optional(),
  sourceFailureCounts: z.record(z.string(), z.number().int().min(0)).optional(),
  sourceDisabledCounts: z.record(z.string(), z.number().int().min(0)).optional(),
