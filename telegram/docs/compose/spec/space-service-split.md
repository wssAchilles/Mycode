...
- [ ] T3: S3 interactions extraction — acceptance: like/unlike/repost/unrepost/comment paths delegate; feature-snapshot side effects preserved; phase tests green (covers: S2; depends: T2)
