...
BASELINE_FILE="${GRAPH_BENCH_BASELINE:-$ROOT_DIR/benchmarks/graph_store_baseline.json}"
if [[ -f "$BASELINE_FILE" ]]; then
  GRAPH_BENCH_BUILD_DIR="$BUILD_DIR" GRAPH_BENCH_FAILURE_MODE=block GRAPH_BENCH_BASELINE_FILE="$BASELINE_FILE" bash "$ROOT_DIR/scripts/perf/check_graph_bench.sh"
else
